...
class LoweringSummaryReport(LoweringReportCreator):  # pylint: disable=too-few-public-methods
    ...
    def export_pdf(self):  # pylint: disable=too-many-locals,too-many-statements,too-many-branches
        ...
        # flowables.append(Paragraph("<b>Cruise PI:</b> %s" % self.cruise_record['cruise_additional_meta']['cruise_pi'] or '', self.body_text))  # noqa: E501
        # flowables.append(Paragraph("<b>Cruise Description:</b> %s" % self.cruise_record['cruise_additional_meta']['cruise_description'] or '', self.body_text))  # noqa: E501
        # flowables.append(Paragraph("<b>Cruise Location:</b> %s" % self.cruise_record['cruise_location'] or '', self.body_text))  # noqa: E501
        ...
        #     flowables.append(Paragraph("No PROBLEM events recorded for this dive", self.body_text))  # noqa: E501
        #     flowables.append(Spacer(PAGE_WIDTH, 1 * cm))
