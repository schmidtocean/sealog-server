...
class CruiseSummaryReport(CruiseReportCreator):  # pylint: disable=too-few-public-methods
    ...
    def export_pdf(self):
        ...
        if dive_locations_image:
            ...
            dive_locations._restrictSize(PAGE_WIDTH - 1 * cm, PAGE_HEIGHT - 7 * cm)  # pylint: disable=protected-access  # noqa: E501
...
if __name__ == '__main__':
    ...
    try:
        ...
        OUTPUT_PATH = parsed_args.output_dir if parsed_args.output_dir else os.path.join(API_SERVER_FILE_PATH, 'cruises', cruise_uid)  # noqa: E501
